class SignInController < ApplicationController
  ...
  REDIRECT_URI = 'http://intense-woodland-5704.herokuapp.com/sign_in/accept' #Redirect users after authentication to this path, ensure that you have set up your routes to handle the callbacks
